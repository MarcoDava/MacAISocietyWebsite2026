...
export const PAST_PARTNERS: Partner[] = [
  { name: 'RBC (Royal Bank of Canada)', alt: 'RBC', year: 2024, tier: 'standard', isCurrent: false, logoUrl: rbcLogo, website: 'https://www.rbc.com' },
  { name: 'Deep Knowledge Group', alt: 'Deep Knowledge Group', year: 2024, tier: 'standard', isCurrent: false, logoUrl: dkgLogo, website: 'https://www.dkv.global/' },
  { name: 'CGI', alt: 'CGI', year: 2024, tier: 'standard', isCurrent: false, logoUrl: cgiLogo, website: 'https://www.cgi.com' },
  { name: 'Intact Insurance', alt: 'Intact Insurance', year: 2024, tier: 'standard', isCurrent: false, logoUrl: intactLogo, website: 'https://www.intact.ca' },
  { name: 'Huawei', alt: 'Huawei', year: 2024, tier: 'standard', isCurrent: false, logoUrl: huaweiLogo, website: 'https://www.huawei.com' },
  { name: 'FDM Group', alt: 'FDM Group', year: 2024, tier: 'standard', isCurrent: false, logoUrl: fdmLogo, website: 'https://www.fdmgroup.com' },
  { name: 'Bell', alt: 'Bell', year: 2023, tier: 'standard', isCurrent: false, logoUrl: bellLogo, website: 'https://www.bell.ca' },
  { name: 'McMaster Students Union (MSU)', alt: 'McMaster Students Union', year: 2023, tier: 'standard', isCurrent: false, logoUrl: msuLogo, website: 'https://www.msumcmaster.ca' },
  { name: 'Inland AI', alt: 'Inland AI', year: 2023, tier: 'standard', isCurrent: false, logoUrl: inlandLogo, website: '#' },
  { name: 'IBM', alt: 'IBM', year: 2023, tier: 'standard', isCurrent: false, logoUrl: ibmLogo, website: 'https://www.ibm.com' },
  { name: 'Riskfuel', alt: 'Riskfuel', year: 2023, tier: 'standard', isCurrent: false, logoUrl: riskfuelLogo, website: 'https://riskfuel.com/' },
  { name: 'OSPE', alt: 'OSPE', year: 2023, tier: 'standard', isCurrent: false, logoUrl: ospeLogo, website: 'https://ospe.on.ca' },
  { name: 'Microsoft', alt: 'Microsoft', year: 2022, tier: 'standard', isCurrent: false, logoUrl: microsoftLogo, website: 'https://www.microsoft.com' },
];
